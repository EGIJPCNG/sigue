  ...
  return (
    ...
    <article className="sg-headerInfo-builder">
      <form className='sg-headerInfo-builder__left'>
        <input className='sg-input sg-input-bgTransparent' type="text" placeholder="Buscar un edificio-aula" />
      ...
      <div className='sg-headerInfo-builder__right'>
          ...
          <div class='sg-headerInfo-divider'></div>
      ...
      <div className='sg-headerLogin-button sg-button'>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user"><path d="M3 21v-2a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
